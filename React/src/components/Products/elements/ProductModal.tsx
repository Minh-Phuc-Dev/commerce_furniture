            ...
            <Modal.Content className="overflow-hidden">
                <div className="flex flex-col w-full h-full max-w-screen-lg rounded bg-white">
                    <div className="px-5 py-2 border-b flex space-x-5 justify-between">
                        <h2 className="font-medium">Chỉnh sửa sản phẩm</h2>
                        <Modal.Trigger
                            mode="close"
                    ...
                    >
                        ...
                        <div className="col-span-2">
                            <h2 className="font-medium">Giá bán</h2>
                            <p className="text-sm opacity-50">Thêm thông tin giá sản phẩm tại đây</p>
                        </div>
                        ...
                        <div className="col-span-2">
                            ...
                            <p className="text-sm opacity-50">Thêm thông tin tồn kho sản phẩm tại đây</p>
                        </div>
                        <div className="space-y-2">
                        ...
                        <div className="col-span-2">
                            <h2 className="font-medium">Tóm tắt</h2>
                                <p className="text-sm opacity-50">Chỉnh sửa mô tả và các thông tin cần thiết của sản phẩm tại đây</p>
                        </div>
