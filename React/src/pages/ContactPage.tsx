      ...
      <section className="flex items-center lg:h-screen font-poppins">
        <div className="justify-center flex-1 max-w-6xl px-4 py-4 mx-auto md:px-6">
          <div className="text-left py-10 space-y-2">
            ...
            <p className="text-sm">
              Cung cấp thông tin của bạn để nhận được sự hỗ trợ tận tình từ
              chúng tôi.
            </p>
          </div>
              ...
              <div className="flex flex-wrap">
                <div className="w-full px-4 mb-10 sm:w-1/2">
                  <div className="max-w-xs mx-auto">
                    <div className="inline-flex items-center justify-center w-12 h-12 mb-6 text-gray-100 bg-blue-700 rounded-full">
                      <svg
            ...
            <div className="w-full px-4 lg:w-1/2">
              <form action="" className="p-6 bg-gray-50">
                ...
                <div className="mb-6 ">
                  ...
                  <input
                    type="text"
                    placeholder="Tôi đang yêu cầu thông tin về..."
                    required={true}
                    className="block w-full px-4 py-3 mb-3 leading-tight text-gray-700 bg-gray-100 border border-gray-200 rounded "
                  />
                </div>
